...
<head>
    ...
    <style>
        body {
            ...
            margin: 0;
            padding: 10px; /* Reduzindo o espaçamento */
        }
        ...
        table {
            ...
            margin-top: 10px; /* Reduzindo o espaçamento */
        ...
        form {
            ...
            margin-bottom: 10px; /* Reduzindo o espaçamento */
        }
        ...
        form label {
            color: #009933;
            margin-right: 5px; /* Reduzindo o espaçamento */
        }
...
<body>
<h1>Olá Administrador TI, Bem Vindo à Visualização de Chamados Comal</h1>
<?php
...
if (isset($_POST["id"]) && isset($_POST["status"])) {
    ...
    $sql = "UPDATE chamados_ti SET status = '$status' WHERE id = $id";
    executeQuery($sql);
}
...
if (isset($_POST["filtro"])) {
    ...
    if ($filtro == "Em Aberto" || $filtro == "Em Andamento" || $filtro == "Completo") {
        $sql = "SELECT * FROM chamados_ti WHERE status = '$filtro'";
    } else {
        $sql = "SELECT * FROM chamados_ti";
    }
