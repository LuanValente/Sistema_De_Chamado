...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO chamados_ti (email, prioridade, assunto, mensagem) VALUES ('$email', '$prioridade', '$assunto', '$mensagem')";
...
<head>
    ...
    <title>Sistema de Chamados Comal</title>
    </head>
<body>
<div class="container">
    <div class="back-btn">
    ...
    <h1>Sistema de Chamados Comal(TI)</h1>
    <form method="post"> 
